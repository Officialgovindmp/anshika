import requests
import random
from GJ516Music import app, filters
from GJ516Music.misc import SUDOERS
from pyrogram import * 
from pyrogram.types import *
from GJ516Music.utils.daxx_ban import admin_filter
...
@app.on_message(filters.command(["govind","anu"], prefixes=["y", "Y"]) & admin_filter)
async def restriction_app(app :app, message):
    reply = message.reply_to_message
    chat_id = message.chat.id
    if len(message.text) < 2:
        return await message.reply(random.choice(kavya_text))
